...
/**
 * The class is instantiated with the username and password, it is then used to
 * add header with these credentials to HTTP requests
 *
 */
public class HttpBasicAuthInterceptor implements HttpRequestInterceptor {
	...
	public void process(HttpRequest httpRequest, HttpContext httpContext)
		...
		Header basicAuthHeader = authScheme.authenticate(credentials,
