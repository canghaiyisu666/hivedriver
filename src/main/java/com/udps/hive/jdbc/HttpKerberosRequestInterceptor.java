...
/**
 *
 * Authentication interceptor which adds Base64 encoded payload, containing the
 * username and kerberos service ticket, to the outgoing http request header.
 *
 */
public class HttpKerberosRequestInterceptor implements HttpRequestInterceptor {
	...
	public void process(HttpRequest httpRequest, HttpContext httpContext)
		...
		try {
			...
			// Locking ensures the tokens are unique in case of concurrent
			// requests
			kerberosLock.lock();
