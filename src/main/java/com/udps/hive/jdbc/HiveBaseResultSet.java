...
public abstract class HiveBaseResultSet implements ResultSet {
	...
	public int findColumn(String columnName) throws SQLException {
		int columnIndex = normalizedColumnNames.indexOf(columnName
				.toLowerCase());
		if (columnIndex == -1) {
	...
	private Object getColumnValue(int columnIndex) throws SQLException {
		...
		Type columnType = getSchema().getColumnDescriptorAt(columnIndex - 1)
				.getType();
