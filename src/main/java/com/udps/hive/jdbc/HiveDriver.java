...
import com.udps.hive.jdbc.Utils.JdbcConnectionParams;
...
public class HiveDriver implements Driver {
   ...
   */
	...
	static int getMajorDriverVersion() {
		int version = -1;
		try {
			String fullVersion = HiveDriver
					.fetchManifestAttribute(Attributes.Name.IMPLEMENTATION_VERSION);
	 ...
	 *
	 * The output from Utils.parseUrl() is massaged for the needs of
	 * getPropertyInfo
	 * 
	 * @param url
	 * @param defaults
	 ...
	 */
	private Properties parseURLforPropertyInfo(String url, Properties defaults)
			throws SQLException {
	 ...
	 * @throws IOException
	 */
	private static synchronized void loadManifestAttributes()
			throws IOException {
